...
c-----------------------------------------------------------------------
      subroutine vec_dssum_part1(u,v,w,nx,ny,nz)
c
...
c     if (ifldt.eq.0)       ifldt = 1
      ...
      call gs_op_many_irecv(gsh_fld(ifldt),u,v,w,u,u,u,ndim,1,1,0)
...
c-----------------------------------------------------------------------
      subroutine vec_dssum_part2(u,v,w,nx,ny,nz)
c
c     Direct stiffness summation of the face data, for field U.
c
c     Boundary condition data corresponds to component IFIELD of 
...
c     if (ifldt.eq.0)       ifldt = 1
      ...
      call gs_op_many_isend(gsh_fld(ifldt),u,v,w,u,u,u,ndim,1,1,0)
      call gs_op_many_wait (gsh_fld(ifldt),u,v,w,u,u,u,ndim,1,1,0)
